...
TORCH_HOME = "./NAS_data"  # Path that contains the nas-bench-201 database. If you only want to run on NASNET (i.e. DARTS) search space, then just leave it empty
data_paths = {
    "cifar10": "NAS_data/cifar.python",
    "cifar100": "NAS_data/cifar.python",
    "ImageNet16-120": "NAS_data/ImageNet16",
    "imagenet-1k": "NAS_data/imagenet_final",
}
